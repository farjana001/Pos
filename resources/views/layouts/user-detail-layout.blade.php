            ...
            <div class="row">
                <div class="col-md-2">
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        ...
                        <a class="nav-link {{ request()->routeIs('user.sales', 'user.sales.invoice.show') ? 'active' : '' }}" href="{{ route('user.sales', $user->id) }}">
                        @if (request()->routeIs('user.sales.invoice.show'))
                        Sales <span><i class="fas fa-caret-right"></i></span> Invoice
                        @else
                        Sales
                        @endif
                        </a>
