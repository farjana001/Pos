                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input onkeyup="getTotal()" type="text" class="form-control" name="quantity" id="purchase_prod_quantity"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input onkeyup="getTotal()" type="text" class="form-control" name="price" id="purchase_prod_price"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input onkeyup="getTotal()" type="text" class="form-control" name="total" id="purchase_price_total"
                                                        placeholder="Enter price">
                                                </div>
                                            </div>
                                        </div>
...
@section('scripts')
    <script>
        const getTotal = () => {
           let saleQuantity = document.getElementById('purchase_prod_quantity').value;
           let unitSalePrice = document.getElementById('purchase_prod_price').value;

           if(saleQuantity && unitSalePrice) {
            document.getElementById('purchase_price_total').value = unitSalePrice * saleQuantity
           }
